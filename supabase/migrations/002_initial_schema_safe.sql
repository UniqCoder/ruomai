...
DROP POLICY IF EXISTS "Users can insert own usage history" ON public.usage_history;
...
DROP POLICY IF EXISTS "Users can insert own monthly usage" ON public.monthly_usage;
DROP POLICY IF EXISTS "Users can update own monthly usage" ON public.monthly_usage;
...
DROP FUNCTION IF EXISTS public.get_current_month_usage(p_user_id UUID) CASCADE;
DROP FUNCTION IF EXISTS public.increment_usage(p_user_id UUID) CASCADE;
